...
--
-- Host: localhost:3306
-- Generation Time: Oct 19, 2022 at 10:42 PM
...
INSERT INTO `tbl_product` (`product_id`, `product_name`, `product_price`, `product_img`, `product_desc`) VALUES
...
ALTER TABLE `tbl_product`
  ...
  ADD KEY `product_price_price_id` (`product_price`),
  ADD KEY `product_img_img_id` (`product_img`),
  ADD KEY `product_desc_desc_id` (`product_desc`);
...
--
ALTER TABLE `tbl_product`
  ADD CONSTRAINT `product_desc_desc_id` FOREIGN KEY (`product_desc`) REFERENCES `tbl_desc` (`desc_id`),
  ADD CONSTRAINT `product_img_img_id` FOREIGN KEY (`product_img`) REFERENCES `tbl_img` (`img_id`),
  ADD CONSTRAINT `product_price_price_id` FOREIGN KEY (`product_price`) REFERENCES `tbl_price` (`price_id`);
COMMIT;
